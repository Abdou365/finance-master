  ...
  return (
    <div>
      <div className=" relative flex flex-col place-items-center mb-8">
        <div className="h-32 w-full">
          <img
            ...
            src="https://cdn.pixabay.com/photo/2017/07/10/19/30/lines-2491184_1280.jpg"
            alt=""
          />
        </div>
        <div className="h-24 w-24 bg-red-400 rounded-full absolute top-16  ">
          <img
            ...
            src="https://cdn.pixabay.com/photo/2016/08/23/16/16/wallpaper-1614874_1280.jpg"
            alt=""
          />
        </div>
      </div>
      <h3 className=" font-medium text-center ">
        ...
        <span className=" block break-all text-2xl ">
          {store.user()?.email}
        </span>
      </h3>{" "}
    </div>
